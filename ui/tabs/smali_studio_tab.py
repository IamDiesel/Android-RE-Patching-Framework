...
class SmaliStudioTab(ttk.Frame):
    def __init__(self, parent, app):
        ...
        # NEU: Keine Parameter mehr übergeben!
        self.search_engine = SmaliSearchEngine()

        # NEU: UI abonniert asynchrone Fortschritts-Updates aus dem RAM-Indexer
    ...
    def create_widgets(self):
        ...
        ttk.Button(top_bar, text="📦 APK Entpacken", command=lambda: self.controller.unpack_apk_async()).pack(side="left", padx=5)
